...
class ConcertsControllerTest < ActionController::TestCase
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post :create, concert: { date: @concert.date, facebook_page: @concert.facebook_page, hashtag: @concert.hashtag, instagram: @concert.instagram, title: @concert.title, twitter: @concert.twitter, venue: @concert.venue }
    end
  ...
  test "should update concert" do
    put :update, id: @concert, concert: { date: @concert.date, facebook_page: @concert.facebook_page, hashtag: @concert.hashtag, instagram: @concert.instagram, title: @concert.title, twitter: @concert.twitter, venue: @concert.venue }
    assert_redirected_to concert_path(assigns(:concert))
  end
